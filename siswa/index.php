          ...
          <tbody>
             ...
             if (mysqli_num_rows($result) > 0) {
                 ...
                 while($row = mysqli_fetch_assoc($result)) {
                     ...
                     echo "<td>"; 
                     echo "<a href='edit.php?id=" . $row['sid'] . "' class='btn btn-warning btn-sn'>Edit</a> &nbsp;"; ?> 
                     <a href="delete.php?id=<?php echo$row['sid']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Data Siswa akan dihapus, Yakin?')">Hapus</a>
                     "</td>";
                     "</tr>";
                     <?php
                     $no++;
